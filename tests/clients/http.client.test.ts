...
describe('HttpClient', () => {
  ...
  describe('HTTP methods', () => {
    it('should make GET request successfully', async () => {
      ...
      expect(axiosMock.default.create().get).toHaveBeenCalledWith('/test', expect.objectContaining({
        headers: undefined,
        timeout: undefined,
        params: undefined,
    ...
    it('should make POST request successfully', async () => {
      ...
      expect(result).toEqual(responseData.data);
      expect(axiosMock.default.create().post).toHaveBeenCalledWith('/test', requestData, expect.objectContaining({
        headers: undefined,
        timeout: undefined,
        params: undefined,
        metadata: expect.objectContaining({
    ...
    it('should make PUT request successfully', async () => {
      ...
      expect(result).toEqual(responseData.data);
      expect(axiosMock.default.create().put).toHaveBeenCalledWith('/test/1', requestData, expect.objectContaining({
        headers: undefined,
        timeout: undefined,
        params: undefined,
        metadata: expect.objectContaining({
    ...
    it('should make DELETE request successfully', async () => {
      ...
      expect(result).toEqual(responseData.data);
      expect(axiosMock.default.create().delete).toHaveBeenCalledWith('/test/1', expect.objectContaining({
        headers: undefined,
        timeout: undefined,
        params: undefined,
        metadata: expect.objectContaining({
